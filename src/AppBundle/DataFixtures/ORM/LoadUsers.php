 ...
 */
class LoadUsers extends AbstractFixture implements OrderedFixtureInterface, FixtureInterface, ContainerAwareInterface
{
    ...
    private function loadFOSUsers(ObjectManager $manager)
    {
        ...
        for($i = 0; $i < 10; $i++) {
            ...
            $user->setEmail('user-' . $i . '@kittyonline.net');
